...
type Consignment struct {
	...
	VessleId    string       `protobuf:"bytes,5,opt,name=vessle_id,json=vessleId,proto3" json:"vessle_id,omitempty"`
}
...
func (x *Consignment) GetVessleId() string {
	if x != nil {
		return x.VessleId
	}
	return ""
...
type Response struct {
	...
	// repeat field means treat this field as an array of Consignment types
...
var file_proto_consignment_consignment_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x72, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x76, 0x65, 0x73, 0x73, 0x6c, 0x65, 0x5f, 0x69,
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x76, 0x65, 0x73, 0x73, 0x6c, 0x65, 0x49,
